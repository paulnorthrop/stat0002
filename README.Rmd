...
If you use a **Mac** then please read the notes at [R Mac OS X](https://cran.r-project.org/bin/macosx/), in particular the 3 paragraphs under **Latest release:**.  You need all of the software described here.  You will also need the BWidget software.  If your Mac does not have this then please see the [BWidget installation instructions](https://moodle.ucl.ac.uk/mod/resource/view.php?id=2389913) on the STAT0002 Moodle page.
