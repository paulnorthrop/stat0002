...
If you use a **Mac** then the movies (interactive plots) in `stat0002` will not work unless you have [XQuartz](https://www.xquartz.org/) installed. For boring technical reasons, the Apple Mac version available below may be missing the functions to produce the movies. However, some of the movies are available from the [smovie](https://paulnorthrop.github.io/smovie/) package.
