...
#' standard normal distribution. This movie can also be opened using
#' \code{smovie::movies()} and selecting \strong{Mean vs median, normal} from
#' the \strong{Sampling distributions} menu.
