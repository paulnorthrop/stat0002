...
devtools::build("../stat0002_1.2.2.tar.gz", binary = TRUE)

# Now move the files to the install directory
file.copy(from = "../stat0002_1.2.2.tar.gz", to = "install/stat0002.tar.gz",
          overwrite = TRUE)
file.copy(from = "../stat0002_1.2.2.zip", to = "install/stat0002.zip",
          overwrite = TRUE)
# Remove the originals
file.remove("../stat0002_1.2.2.tar.gz")
file.remove("../stat0002_1.2.2.zip")
