...
The R code used in this vignette are available: [descriptive-statistics-vignette.R](stat0002-ch2a-descriptive-statistics-vignette.R).
 The functions `five_number`, `skew` and `q_skew` can be viewed either by typing the name of the function at R command prompt `>` or at  [GitHub](https://github.com/paulnorthrop/stat0002/tree/master/R/descriptive_statistics.R)
