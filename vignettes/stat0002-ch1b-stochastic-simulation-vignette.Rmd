...
The R code used in this vignette are available: [stochastic-simulation-vignette.R](stat0002-ch1b-stochastic-simulation-vignette.R).
 The function `rbinomial` can be viewed either by typing `rbinomial` at R command prompt `>` or at  [GitHub](https://github.com/paulnorthrop/stat0002/blob/master/R/stochastic_simulation.R)
