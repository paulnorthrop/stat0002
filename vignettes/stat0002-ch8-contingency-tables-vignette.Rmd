...
x2test$residuals
x2test$stdres
assoc(ga, shade = TRUE, residuals = x2test$stdres)
strucplot(ga, shade = TRUE, residuals = x2test$stdres, residuals_type = "Standardised Pearson")
```
